  ...
  return (
    <div className="designation-page">
      <div className="designation-main">
        ...
        <div className="designation-header">
          <div>
            ...
            <p className="designation-subtitle">
              Manage employee leave balances, applications, and carry-forwards
            </p>
          </div>
        </div>
        ...
        {message && (
          <div
            className={`designation-error`}
            style={{
              background: message.isError ? "#ffdad6" : "#d1fae5",
              borderColor: message.isError ? "#ba1a1a" : "#059669",
              color: message.isError ? "#93000a" : "#065f46",
            }}
          >
            {message.text}
          </div>
        ...
        <div className="directory-tabs" style={{ marginBottom: 24 }}>
          {sections.map((s) => (
            <button
              key={s.key}
              className={activeSection === s.key ? "directory-tab-active" : ""}
        ...
        {activeSection === "assign" && (
          <div className="designation-table-card">
            <div className="table-toolbar">
              <h3>Auto-Assign Leave Balance</h3>
            </div>
            <div style={{ padding: 24 }}>
              <p style={{ color: "#737784", fontSize: 14, marginBottom: 20 }}>
                Creates leave balance entries for the selected financial year.
                Choose which leave types to assign and their day counts.
              </p>
              ...
              <div className="form-group" style={{ marginTop: 16 }}>
                ...
                <input
                  value={assignFY}
                  onChange={(e) => setAssignFY(e.target.value)}
                    ...
                    <tbody>
                      {assignLeaveConfigs.map((cfg, i) => (
                        <tr key={cfg.code}>
                          ...
                          <td style={{ fontWeight: 600, color: "#191b22" }}>
                            {cfg.label} ({cfg.code})
                          </td>
                          <td>
                            <input
              ...
              >
                ...
                {assignResult && (
                  <span
                    style={{
                      color: assignResult.error ? "#ba1a1a" : "#059669",
                      fontSize: 14,
                    }}
                  >
            ...
            <div style={{ padding: 24 }}>
              ...
              {viewData && (
                <div style={{ marginTop: 24 }}>
                  <h4 style={{ margin: "0 0 4px", color: "#191b22" }}>
                    {viewData.employee || `Employee #${viewEmpId}`}
                  </h4>
                  <p
                    style={{ color: "#737784", fontSize: 13, marginBottom: 16 }}
                  >
                    FY: {viewData.financial_year || viewYear || "Current"} |
                    Total Remaining: {viewData.total || 0}
                  </p>
                  {viewData.leaves?.length > 0 ? (
                    ...
                    >
                      {viewData.message || "No balance found"}
                    </p>
                  )}
                </div>
              )}
        ...
        {activeSection === "history" && (
          <div className="designation-table-card">
            ...
            <div style={{ padding: 24 }}>
              ...
              {histData && (
                <div style={{ marginTop: 24 }}>
                  <p style={{ color: "#737784", marginBottom: 12 }}>
                    {histData.total || 0} application(s)
                  </p>
          ...
          <div className="designation-table-card">
            ...
            >
              ...
              <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
                <input
                  ...
                  value={approvalAdmin}
                  onChange={(e) => setApprovalAdmin(e.target.value)}
                  style={{
                    width: 100,
                    border: "1px solid #c3c6d5",
                    borderRadius: 8,
            ...
            <div style={{ padding: 24 }}>
              {approvals.length === 0 && !loading && (
                <p
                  style={{ color: "#737784", textAlign: "center", padding: 20 }}
                >
                  No pending applications. Click "Load Pending" to fetch.
                </p>
              )}
              {loading && (
                <p
          ...
          <div className="designation-table-card">
            ...
            <div style={{ padding: 24 }}>
              ...
              >
                ...
                <div className="form-group">
                  <label>Adjusted By (Admin ID)</label>
                  <input
                    type="number"
              ...
              <button
                className="save-btn"
                style={{
                  background: adjType === "CREDIT" ? "#059669" : "#dc2626",
                }}
                onClick={handleAdjustment}
                disabled={loading}
              >
                {loading ? "Applying..." : `Apply ${adjType}`}
              </button>
              {adjResult && (
                <div
                  style={{
                    marginTop: 12,
                    color: adjResult.error ? "#ba1a1a" : "#059669",
                    fontSize: 14,
                  }}
                >
                  <p>{adjResult.error || adjResult.message}</p>
                  {adjResult.data && (
                    <p style={{ color: "#434653" }}>
                      New Total: {adjResult.data.new_total_days} | Remaining:{" "}
                      {adjResult.data.new_remaining_days}
                    </p>
                  )}
                </div>
              )}
        ...
        {activeSection === "carry" && (
          <div className="designation-table-card">
            <div className="table-toolbar">
              <h3>Year-End EL Carry Forward</h3>
            </div>
            <div style={{ padding: 24 }}>
              <p style={{ color: "#737784", fontSize: 14, marginBottom: 20 }}>
                Carries forward remaining Earned Leave (EL) balances from the
                old financial year to the new one (max 15 days).
              </p>
              <div
                style={{
                  display: "flex",
              ...
              {cfResult && (
                <div
                  style={{
                    marginTop: 12,
                    color: cfResult.error ? "#ba1a1a" : "#059669",
                    fontSize: 14,
                  }}
                >
                  <p>{cfResult.error || cfResult.message}</p>
                  {cfResult.employees_updated !== undefined && (
                    <p style={{ color: "#434653" }}>
                      Employees updated: {cfResult.employees_updated} |{" "}
                      {cfResult.from} → {cfResult.to}
                    </p>
                  )}
                </div>
              )}
